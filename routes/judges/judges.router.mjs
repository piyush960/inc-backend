...
function createJudgesRouter(judgesServices, eventsServices, emailService, middlewares, judgesValidations, adminValidations, eventsValidations) {
    ...
    const { getJudgeFromToken,getJudgeFromJid , getSlots ,loginJudge, getProjects, getJudges , getAllocatedProjects } = gettingJudgesController(judgesServices, eventsServices)
    ...
    judgesRouter.post('/modifySlot/:jid' , getSlots)
